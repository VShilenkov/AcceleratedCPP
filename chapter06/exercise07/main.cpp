 ...
 *    @file       main.cpp
 *    @author     VShylienkov
 *    @brief      Параграф 06. Упражнение 07. Страница 152.
 *
 *    Часть программы анализа методов вычисления оценок из раздела 6.2.1, которая
 *    читает и классифицирует записи в зависимости от того, сдали ли студенты все
 *    домашние задания, аналогична задаче, которую мы решаем в функции
 *    extract_fails. НАпишите функцию для реализации этой подзадачи.
 *
...
int main( )
{
    ...
    auto iter = std::partition(did.begin(), did.end(), did_all_hw);
    std::vector<Student_info> didnt(iter, did.end());
